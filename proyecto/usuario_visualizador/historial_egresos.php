...
<html>
    ...
    <body>
        <div class="container-fluid">
            <br>
            <center><h1 style="font-size: 27px">PROCESAR EGRESO</h1></center>
            <br>
            <center><table class="table table-bordered anotherhover table-striped table-responsive-sm" id="tabla" style="font-size: 13px; color: #424242">
                    <tr>
                        ...
                        <td class="btn-info" style="background-color: #12548c">Egreso</td>
                    </tr>
                    <?php
                    ...
                    $sql = "select
                        ...
                        where pet.estado = 2 AND pet.nombre_archivo != ''
                        ORDER BY id DESC";
                    ...
                    while ($datos = $db->fetch_row($query)) {
                        ...
                        <tr>
                            ...
                            <td><?php echo '<center><a href="../usuario_visualizador/egreso_procesado.php?id=' . $datos['id'] . '"><input type="image" src="../imagenes/Editar.png" width="30" height="30"></a></center>'; ?></td>
                        </tr>
