...
<html>
    ...
    <div class="container-fluid">
        <form method="POST" id="form" action="../usuario_solicitante/pdf_finalizado.php">
            ...
            <br>
            <br>
            <a href="../usuario_autorizador/historial_solicitudes.php?idEstado=7"><input type="button" style="background-color: #12548c; border: #12548c;" value="Volver" class="btn btn-primary offset-sm-3"></a>
