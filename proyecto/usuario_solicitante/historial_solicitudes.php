                ...
                if (isset($_POST['buscar'])) {
                    ...
                    while ($datos = $db->fetch_row($query)) {
                        ...
                        <tr>
                            ...
                            if ($_REQUEST['idEstado'] == 2) {
                                ...
                                if (empty($datos['nombre_archivo'])) {
                                    ?>
                                    <td><?php echo '<a class="" style="color: #fff" href="../usuario_solicitante/archivo_aceptado.php?id=' . $datos['id'] . '"><center><input type="image" style="width: 50px; height: 40px" src="../imagenes/2018-07-18.png"></center></a>' ?></td>
                                    <?php
                                } else {
                                    ?>
                            ...
                            if ($_REQUEST['idEstado'] == 4) {
                                ...
                                <td><?php
                                    $z = number_format($datos['montoRescatado']);
                                    echo str_replace(',', '.', $z);
                                    ?></td>
                                <?php
                        ...
                        if ($_REQUEST['idEstado'] == 7) {
                            ...
                            <td><?php echo '<a class="" href="../usuario_solicitante/inversion_finalizada.php?id=' . $datos['id'] . '"><center><input type="image" src="../imagenes/checklist2.png" width="35" height="35"></center></a>' ?></td>
                            <?php
                        }
                    }
    ...
    while ($datos = $db->fetch_row($query)) {
        ...
        <tr>
            ...
            if ($_REQUEST['idEstado'] == 4) {
                ...
                <td><?php echo $fila2['rentabilidad']; ?></td>
                <td><?php
                    $z = number_format($filita['montoRescatado']);
                    echo str_replace(',', '.', $z);
                    ?></td>
...
<script>
    ...
    function redireccionar(obj) {
        ...
        document.location = 'https://pcspucv.cl/gsi/proyecto/usuario_solicitante/historial_solicitudes.php?idEstado=' + valorSeleccionado;
    }
